...
set_target_properties(absl::test_allocator PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;protobuf::gmock;-ignore:4221"
)
...
add_library(absl::scoped_mock_log INTERFACE IMPORTED)
...
# Create imported target absl::abseil_test_dll
add_library(absl::abseil_test_dll SHARED IMPORTED)

set_target_properties(absl::abseil_test_dll PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "GTEST_LINKED_AS_SHARED_LIBRARY=1;ABSL_CONSUME_TEST_DLL"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)
